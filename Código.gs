...
function ObtenerDatos() {
  ...
  if(opc1Ambito == "Nuevas tecnologías"){
    ...
    +"Si está decidido/a a iniciar con nosotros el curso tendrá que proceder al proceso de matricula, para hacerlo haga click en el siguieante enlace. Gracias " +enlaceNuevasTec
    +" "
  ...
  if(opc1Ambito == "Comunicación audiovisual"){
    ...
    +" estarás rodeado de lo mejores profesionales y el mejor material didáctico para poder avanzar de forma progresiva en tu curso y poder ser un gran profesional del entorno "
    +"Si está decidido/a a iniciar con nosotros el curso tendrá que proceder al proceso de matricula, para hacerlo haga click en el siguieante enlace. Gracias " +enlaceComunicacion
    +" "
    +" Atentamente el grupo de coordinación y orientación de EUSA."
